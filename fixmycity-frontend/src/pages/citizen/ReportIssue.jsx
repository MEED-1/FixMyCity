...
function ReportIssue() {
    ...
    const [formData, setFormData] = useState({
        ...
        category: '',
        priority: 'medium',
        municipality: useAuthStore.getState().user?.municipality || '',
        latitude: null,
        longitude: null,
        photos: []
    });
    ...
    useEffect(() => {
        const fetchLookups = async () => {
            try {
                const [catsData, munsData] = await Promise.all([
        ...
        <DashboardLayout>
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-1 text-muted-foreground">Help us improve your city, one report at a time.</p>
                </div>
                ...
                <div className="card-3d p-6 sm:p-10 min-h-[400px]">
                        ...
                        <div className="text-center">
                            <div className="border-2 border-dashed border-gray-300 dark:border-white/10 rounded-3xl p-10 hover:border-primary transition-colors cursor-pointer bg-gray-50 dark:bg-surface/50 shadow-inner">
                                <label className="cursor-pointer block">
                                    ...
                                    <span className="text-lg font-medium text-gray-900 dark:text-white block">Upload Photos</span>
                                    <span className="text-sm text-gray-500 block mt-2">Click to select files</span>
                    ...
                    {currentStep === 4 && (
                        <div>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Click on the map or use the location button to pin the exact spot.</p>
                            <LocationPicker
                    ...
                    {currentStep === 5 && (
                        <div className="space-y-6">
                            ...
                            <div className="border-b border-gray-200 dark:border-gray-700 pb-4">
                                <h3 className="text-sm uppercase tracking-wide text-gray-500 font-bold mb-2">Photos</h3>
                                <div className="flex gap-2">
                                    {imagePreviews.map((src, i) => (
                                        <img key={i} src={src} className="w-16 h-16 rounded-lg object-cover border border-gray-200 dark:border-gray-700" alt="Evidence" />
                                    ))}
                                    {imagePreviews.length === 0 && <span className="text-gray-500 italic">No photos attached</span>}
                                </div>
                            </div>
                            <div>
                ...
                <div className="mt-8 flex justify-between">
                    ...
                    {currentStep < 5 ? (
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="btn-primary-3d w-full sm:w-auto"
                        >
